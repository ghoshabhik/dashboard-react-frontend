...
export default function ExamMenu({ selectedVal , keyId, user}) {
  ...
  const handleClose = async (e) => {
    ...
    const response = await fetch(`https://dashboard-strapi-backend.herokuapp.com/exams/updateStatus?id=${keyId}&status=${e.currentTarget.innerText}`, 
        {
            method: 'GET',
            headers: {
  ...
  return (
    <div>
      ...
      >
        ...
        <MenuItem onClick={handleClose}>Deferred</MenuItem>
